...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * |------+------+------+------+------+------|  |------+------+------+------+------+------|
   * | Ctrl |  Win |  Alt |  RGB | ADJ  | Space|  | ALTGr|  FN  | Left | Down | Up   |Right |
   * \------+------+------+------+------+------/  \------+------+------+------+------+------/
   */
  ...
  RGB_TOG, KC_LCTL, KC_LALT, KC_LGUI, ADJ,     KC_SPC,  KC_RALT, FN,      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT
),
  ...
  [_ADJ] =  LAYOUT_ortho_5x12(
    ...
    _______, RGB_HUD, RGB_VAD, RGB_HUI, RGBRST,  _______, _______, _______, _______, _______, _______, _______,
