...
#define VIM_ESC MT(MOD_HYPR, KC_ESC)
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTZmac] = LAYOUT(
        KC_GESC,  DE_1,    DE_2,    DE_3,    DE_4,    DE_5,    DE_MINS,                  KC_EQL,  DE_6,    DE_7,    DE_8,    DE_9,    DE_0,    DE_SS,
        KC_TAB,   KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_LBRC,                  KC_RBRC, KC_Z,    KC_U,    KC_I,    KC_O,    KC_P,    DE_UDIA,
        VIM_ESC,  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_LPRN,                  KC_RPRN, KC_H,    KC_J,    KC_K,    KC_L,    DE_ODIA, DE_ADIA,
        KC_LSFT,  KC_Z,    KC_Y,    KC_C,    KC_V,    KC_B,    KC_LCBR,                  KC_RCBR, KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_SFTENT,
                                    KC_LCTL, KC_LALT,  KC_BSPC, SYMB , KC_LGUI, KC_ENT,  GAME, KC_SPC,  RGB_TOG, ADJUST,
