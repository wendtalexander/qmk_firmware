...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [_QWERTY] = LAYOUT(
    KC_GRV,      KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_Q,     KC_Q,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,   KC_TAB,
    KC_TAB,      KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Q,     KC_Q,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,  KC_BSLS,
    FN_CAPS,     KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_Q,     KC_Q,     KC_H,     KC_J,     KC_K,     KC_L,  KC_SCLN,  KC_QUOT,
    KC_LSFT,     KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_Q,     KC_Q,     KC_N,     KC_M,  KC_COMM,   KC_DOT,  KC_SLSH,   KC_ENT,
    KC_LCTL,  KC_LGUI,  KC_LALT,  RGB_TOG,   ADJUST,   KC_SPC,     KC_Q,     KC_Q,   KC_SPC,       FN,  KC_LEFT,  KC_DOWN,    KC_UP, KC_RIGHT,
  ...
  */
  [_COLEMAK] = LAYOUT(
    KC_GESC,     KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_Q,     KC_Q,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,  KC_BSPC,
     KC_TAB,     KC_Q,     KC_W,     KC_F,     KC_P,     KC_B,     KC_Q,     KC_Q,     KC_J,     KC_L,     KC_U,     KC_Y,  KC_SCLN,  KC_BSLS,
    FN_CAPS,     KC_A,     KC_R,     KC_S,     KC_T,     KC_G,     KC_Q,     KC_Q,     KC_K,     KC_N,     KC_E,     KC_I,     KC_O,  KC_QUOT,
    KC_LSFT,     KC_Z,     KC_X,     KC_C,     KC_D,     KC_V,     KC_Q,     KC_Q,     KC_M,     KC_H,  KC_COMM,   KC_DOT,  KC_SLSH,   KC_ENT,
    KC_LCTL,  KC_LGUI,  KC_LALT,  RGB_TOG,   ADJUST,   KC_SPC,     KC_Q,     KC_Q,   KC_SPC,       FN,  KC_LEFT,  KC_DOWN,    KC_UP, KC_RIGHT,
